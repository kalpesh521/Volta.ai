"""initial auth schema: users, refresh_tokens, auth_providers, password_reset_tokens
...
def upgrade() -> None:
    op.create_table(
        ...
        # Nullable: OAuth-only users have no password until/unless they set one.
    ...
    op.create_table(
        ...
        # SHA-256 hex digest only - raw refresh tokens are never persisted.
    ...
    op.create_table(
        ...
        # One user can link many providers; a given provider identity maps to exactly one user.
